...
public final class CentralAvisosView {
    ...
    private TextField criarCampoHora(
        ...
        TextField campo =
                new TextField(valorInicial);

        campo.setPromptText("HH:mm");
    ...
    private boolean validarCampos() {
        ...
        if (
                publicarDataPicker.getValue() == null
                        || !horaValida(
                        publicarHoraField.getText()
                )
        ) {
        ...
        boolean temExpiracao =
                expirarDataPicker.getValue() != null
                        || !expirarHoraField
                        .getText()
                        .isBlank();
        ...
        if (temExpiracao) {
            ...
            if (
                    expirarDataPicker.getValue() == null
                            || !horaValida(
                            expirarHoraField.getText()
                    )
            ) {

                feedbackLabel.setText(
                        "Preencha data e horário de expiração completos, ou deixe os dois em branco."
                );
    ...
    private LocalDateTime obterDataExpiracao() {
        ...
        if (
                expirarDataPicker.getValue() == null
                        || expirarHoraField.getText().isBlank()
        ) {
            return null;
        }
    ...
    private void realizarEnvio() {
        ...
        String mensagem =
                mensagemArea.getText().trim();

        String link =
                linkIntranetField.getText().trim();
        ...
        Thread envio =
                new Thread(() -> {
                    ...
                    try {
                        ...
                        new IntranetAvisosClient().enviar(
                                titulo,
                                mensagem,
                                nivel,
                                link,
            ...
            Thread t =
                    new Thread(() -> {
                        ...
                        try {
                            ...
                            Platform.runLater(
                                    () -> atualizarInterfaceMonitor(stat)
                            );
    ...
    private void configuracoes() {
        ...
        config.getChildren().addAll(
                ...
                criarLabel(
                        "Informe apenas a URL base. Os endpoints /api/avisos e /api/visitas são adicionados automaticamente."
                ),
