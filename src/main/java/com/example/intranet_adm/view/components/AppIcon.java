...
public final class AppIcon {
    ...
    public enum Type {
        ...
        BUILDING("M4 21V3h12v4h4v14h-7v-4h-2v4H4zm2-2h3v-4h6v4h3V9h-4V5H6v14zm2-12h2v2H8V7zm4 0h2v2h-2V7zm-4 4h2v2H8v-2zm4 0h2v2h-2v-2z"),
        CHECK("M9 16.2 4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4z"),
        WARNING("M1 21h22L12 2 1 21zm12-3h-2v-2h2v2zm0-4h-2v-4h2v4z"),
        CALENDAR("M19 4h-1V2h-2v2H8V2H6v2H5C3.9 4 3 4.9 3 6v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V9h14v11z"),
        CLOCK("M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm1 11h5v-2h-4V6h-2v6l1 1z"),
        EXTERNAL_LINK("M14 3v2h3.6l-9.9 9.9 1.4 1.4L19 6.4V10h2V3h-7zM5 5c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2v-7h-2v7H5V7h7V5H5z"),
